...
import { RegisterReqBody, LogutReqBody } from '~/models/requests/User.request'
...
export const logoutController = async (req: Request<ParamsDictionary, any, LogutReqBody>, res: Response) => {
